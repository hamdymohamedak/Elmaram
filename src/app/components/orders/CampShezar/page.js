...
import styles from "./CampShezar.module.css";
...
export default function Page() {
  ...
  const handleSubmit = async () => {
    if (phoneNumber.length === 11) {
      const apiEndpoint =
        "https://api.telegram.org/bot6936969992:AAHAWESVrhzcUHzBFXqFNhuuBNqA77kZmrk/sendMessage";
      const chatId = -1002001682389;
    ...
    <div className={styles.parent}>
      <form className={styles.form}>
        ...
        <p dir="rtl" className={styles.message}>
          17 شارع عمر لطفي محطه ترام الجامعه 
        </p>
        <label>
          <input
